...
- `cmd/` — CLI commands (Cobra): root, init, new, list, show, pick, status, note, leader, work, review, hook, spawn
...
- `internal/spawn/` — Multi-agent orchestration: backend interface, worktree management, prompt building, worker status
