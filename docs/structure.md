...
- `cmd/` — CLI commands (Cobra): root, init, new, list, show, pick, status, note, review, leader, work, launch, spawn, hook, hooks\_install, assign, hold, unhold, close, cancel, handoff, override, context, web
